...
`;var Alert_decorate=function(t,e,i,o){var r,n=arguments.length,a=n<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(a=(n<3?r(a):n>3?r(e,i,a):r(e,i))||a);return n>3&&a&&Object.defineProperty(e,i,a),a},Alert_metadata=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let AlertComponentWC=class extends lit.WF{constructor(){super(...arguments),this.id="",this.visible=!1,this.title="",this.variant="error"}static#_=this.styles=Alert_style_css;updated(t){super.updated(t),(0,validateRequiredProperties.N)(this,["id"])}_close(){const t=new CustomEvent("on-close",{detail:{id:this.id},bubbles:!0,composed:!0});this.dispatchEvent(t),this.visible=!1}render(){return lit.qy`
        ...
        <div class="notification-content ${this.visible?"visible":""} ${this.variant}">
          <div class="notification-header">
            ...
            <ta-button
              ...
              iconOnly
              variant="${"error"===this.variant?dist_button.Ak.Destruct:dist_button.Ak.Primary}"
              ariaLabel="Close"
              @click="${this._close}"
...
//# sourceMappingURL=main.b52003f1.iframe.bundle.js.map