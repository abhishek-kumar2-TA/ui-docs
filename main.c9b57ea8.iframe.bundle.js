...
`;var validateRequiredProperties=__webpack_require__("../../packages/ui/dist/utils/validateRequiredProperties.js"),__decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r},__metadata=function(k,v){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(k,v)};let ButtonComponentWC=class ButtonComponentWC extends lit.WF{constructor(){super(...arguments),this.id="",this.type="button",this.variant=ButtonVariant.Primary,this.size=ButtonSize.Default,this.disabled=!1}static#_=this.styles=style_css;_handleClick(event){if(this.disabled&&(event.preventDefault(),event.stopPropagation()),"submit"===this.type){const form=this.closest("form");form&&form.requestSubmit()}}updated(changedProperties){super.updated(changedProperties),(0,validateRequiredProperties.N)(this,["id"])}setFocus(){const button=this.shadowRoot?.querySelector("button");button?.focus()}render(){return lit.qy`
      <button
...
`;var FieldWrapper_decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let FieldWrapperComponentWC=class FieldWrapperComponentWC extends lit.WF{static#_=this.styles=FieldWrapper_style_css;render(){return lit.qy`
